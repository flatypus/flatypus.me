...
const basicColors = ["#FF0000", "#FF7F00", "#FFFF00", "#00FF00", "#00f2ff", "#0000FF", "#4B0082", "#9400D3"];
...
export default function ColorPicker({
  ...
  return (
    <div className={styles.colorpickerwrapper} style={{ width: WIDTH }} ref={innerDivRef}>
      {!disableTextInput && <TextInput label="Hex:" onChange={onSetHex} value={inputColor} />}
      <div className={styles.colorpickerbasiccolor}>
        {basicColors.map((basicColor) => (
          <button
            className={
              basicColor === selfColor.hex
                ? styles.colorpickerbasiccolorbuttonactive
                : styles.colorpickerbasiccolorbutton
            }
            key={basicColor}
